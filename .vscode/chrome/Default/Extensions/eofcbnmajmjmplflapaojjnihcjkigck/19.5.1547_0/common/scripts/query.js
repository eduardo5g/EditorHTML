...
AvastWRC.Query.Scrapers = function (options) {
    ...
    this.options = _.extend({
        server: AvastWRC.Query.CONST.SAFESHOP_SERVERS[AvastWRC.CONFIG.serverType] + AvastWRC.Query.CONST.SAFESHOP_ENDPOINTS[5],
        method: "post",
        timeout: 10000, // 10s
        client_info: {},
        url: null,
...
AvastWRC.Query.SafeShopOffer = function (options) {
    ...
    this.options = _.extend({
        server: AvastWRC.Query.CONST.SAFESHOP_SERVERS[AvastWRC.CONFIG.serverType] + AvastWRC.Query.CONST.SAFESHOP_ENDPOINTS[6],
        method: "post",
        timeout: 10000, // 10s
        url: null,
        callback: _.noop,
...
AvastWRC.Query.SafeShopOffer.prototype = _.extend({}, AvastWRC.Query.__MASTER__, {
    ...
    format: function () {
        ...
        res.suppress_x_timeout = false; //(resp.suppress_x_timeout !== undefined) ? resp.suppress_x_timeout : false;
